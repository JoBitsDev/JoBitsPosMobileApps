...
public class UbicacionModel implements Serializable {
    ...
    public static UbicacionModel[] getDefaultArrayUbicaciones() {
        return new UbicacionModel[]{new UbicacionModel(NOMBRE_XD, IP_XD, PUERTO_XD), new UbicacionModel(NOMBRE_XD, "192.168.173.2", PUERTO_XD), new UbicacionModel(NOMBRE_XD, "192.168.173.3", PUERTO_XD), new UbicacionModel(NOMBRE_XD, "192.168.173.4", PUERTO_XD)};
    }
