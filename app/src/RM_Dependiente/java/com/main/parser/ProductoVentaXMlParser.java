 ...
 */
public class ProductoVentaXMlParser extends AbstractXmlParser<ProductoVenta> {
    ...
    @Override
    public ProductoVenta readEntry(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        return new ProductoVenta(nombreCocina,nombre,id,Float.valueOf(precio),nombreSeccion);
    }
