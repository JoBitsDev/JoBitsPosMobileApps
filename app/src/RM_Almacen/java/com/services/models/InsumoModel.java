...
public class InsumoModel {
    ...
    public InsumoModel(String codInsumo, String nombre, String um, Float costoPorUnidad, Float stockEstimation) {
    ...
    public InsumoModel(String codInsumo) {
        this.codInsumo = codInsumo;
    }

    public InsumoModel(String codInsumo, String nombre) {
        this.codInsumo = codInsumo;
        this.nombre = nombre;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InsumoModel)) {
            return false;
        }
        InsumoModel other = (InsumoModel) object;
