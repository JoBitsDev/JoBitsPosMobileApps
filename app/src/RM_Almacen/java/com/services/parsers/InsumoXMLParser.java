...
public class InsumoXMLParser extends AbstractXmlParser<InsumoModel> {
    ...
    @Override
    public InsumoModel readEntry(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        i = new InsumoModel(cod_insumo, nombre, um, Float.parseFloat(costo_por_unidad),Float.parseFloat(stock_estimation));
