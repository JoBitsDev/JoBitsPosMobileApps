 ...
 *
 * @extends de ArrayAdapter para poder implementar un nuevo adapter basado en el modelo IpvRegistroModel
 */
...
public class IPVsAdapter extends ArrayAdapter<String> implements Filterable {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (item == null) {
            ...
            item = inflater.inflate(R.layout.list_ipv_cocina, null);
